				...
				},
				{
					...
					render: function(data, type, full, meta) {
						return '<a target="_BLANK" href="'+data+'">'+
									'<div style="width:100%;" class="btn btn-success btn-shadow-hover font-weight-bold mr-2" data-id="'+full.id+'">من هنا</div>'+
								'</a>';
					},
				},
				{
				...
				},
				{
					...
					render: function(data, type, full, meta) {
						...
						if($('input[name="data-area"]').val() == 1){
							editButton = '<a href="/backend/photos/edit/'+data+'" class="dropdown-item">'+
