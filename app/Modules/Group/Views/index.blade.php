                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/backend/groups') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ URL::to('/assets/components/group-datatables.js')}}"></script>           
<script src="{{ URL::to('/assets/components/group.js')}}"></script>           
@endsection
