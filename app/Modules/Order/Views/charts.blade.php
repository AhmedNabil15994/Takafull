    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                <!--begin::Page Title-->
                <h3 class="text-dark font-weight-bold my-1 mr-5 m-subheader__title--separator"></h3>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ URL::to('/backend/'.$data->url) }}" class="text-muted"></a>
                    </li>
                    <li class="breadcrumb-item">
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد اضافة </h3>
        <p class="label-desc">هنا يتم عرض عدد اضافة  في الموقع</p>
        <div id="chart_3"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد تعديل </h3>
        <p class="label-desc">هنا يتم عرض عدد تعديل  في الموقع</p>
        <div id="chart_1"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد تعديل سريع </h3>
        <p class="label-desc">هنا يتم عرض عدد تعديل سريع  في الموقع</p>
        <div id="chart_2"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد حذف </h3>
        <p class="label-desc">هنا يتم عرض عدد حذف  في الموقع</p>
        <div id="chart_5"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">اجمالي عمليات </h3>
        <p class="label-desc">هنا يتم عرض عدد جميع العمليات علي  في الموقع</p>
        <div id="chart_13"></div>
    </div>
</div>
<!--end::Cards-->
