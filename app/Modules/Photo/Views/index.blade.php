...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">مكتبة الصور</h3>
        </div>
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-photo'))
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/backend/photos') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-photo') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-photo') }}">
        <!--begin: Datatable-->
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ URL::to('/assets/components/photos-datatables.js')}}"></script>           
<script src="{{ URL::to('/assets/components/photos.js')}}"></script>    
