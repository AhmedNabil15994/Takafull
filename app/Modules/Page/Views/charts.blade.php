...
@section('title','الصفحات - الاحصائيات')
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ URL::to('/backend/pages') }}" class="text-muted">الصفحات</a>
                    </li>
                    <li class="breadcrumb-item">
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد اضافة الصفحات</h3>
        <p class="label-desc">هنا يتم عرض عدد اضافة الصفحات في الموقع</p>
        <div id="chart_3"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد تعديل الصفحات</h3>
        <p class="label-desc">هنا يتم عرض عدد تعديل الصفحات في الموقع</p>
        <div id="chart_1"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد تعديل سريع الصفحات</h3>
        <p class="label-desc">هنا يتم عرض عدد تعديل سريع الصفحات في الموقع</p>
        <div id="chart_2"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد حذف الصفحات</h3>
        <p class="label-desc">هنا يتم عرض عدد حذف الصفحات في الموقع</p>
        <div id="chart_5"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">اجمالي عمليات الصفحات</h3>
        <p class="label-desc">هنا يتم عرض عدد جميع العمليات علي الصفحات في الموقع</p>
        <div id="chart_13"></div>
    </div>
</div>
<!--end::Cards-->
