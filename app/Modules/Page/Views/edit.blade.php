    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="{{ URL::to('/backend/pages/update/'.$data->data->id) }}">  
                    @csrf
...
<script src="{{ URL::to('/assets/components/page-edit.js') }}"></script>
