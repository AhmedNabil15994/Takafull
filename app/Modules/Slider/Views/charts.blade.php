...
@section('title','الاسلايدر - الاحصائيات')
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ URL::to('/backend/sliders') }}" class="text-muted">الاسلايدر</a>
                    </li>
                    <li class="breadcrumb-item">
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد اضافة الاسلايدر</h3>
        <p class="label-desc">هنا يتم عرض عدد اضافة الاسلايدر في الموقع</p>
        <div id="chart_3"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد تعديل الاسلايدر</h3>
        <p class="label-desc">هنا يتم عرض عدد تعديل الاسلايدر في الموقع</p>
        <div id="chart_1"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد تعديل سريع الاسلايدر</h3>
        <p class="label-desc">هنا يتم عرض عدد تعديل سريع الاسلايدر في الموقع</p>
        <div id="chart_2"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">عدد حذف الاسلايدر</h3>
        <p class="label-desc">هنا يتم عرض عدد حذف الاسلايدر في الموقع</p>
        <div id="chart_5"></div>
    </div>
</div>
...
<div class="card card-custom gutter-b">
    <div class="card-body">
        <h3 class="card-label">اجمالي عمليات الاسلايدر</h3>
        <p class="label-desc">هنا يتم عرض عدد جميع العمليات علي الاسلايدر في الموقع</p>
        <div id="chart_13"></div>
    </div>
</div>
<!--end::Cards-->
