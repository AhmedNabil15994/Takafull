        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ URL::to('/backend/photos') }}" class="text-muted">مكتبة الملفات</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">مكتبة الملفات</h3>
        </div>
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-file'))
    ...
    <div class="card-body">
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-file') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-file') }}">
        <!--begin: Datatable-->
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ URL::to('/assets/components/files-datatables.js')}}"></script>           
<script src="{{ URL::to('/assets/components/files.js')}}"></script>    
